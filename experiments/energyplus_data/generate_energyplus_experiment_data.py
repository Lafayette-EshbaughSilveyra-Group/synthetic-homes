...
def generate_summary_statistics_version(full_experimental_set_data):
    ...
    with open(os.path.join(os.path.dirname(full_experimental_set_data), 'experimental_set_summary_stats.json'),
              'w') as f:
...
parse_eplusout_csvs_to_json(os.getcwd(), os.path.join(os.getcwd(), "experimental_set.json"))
generate_summary_statistics_version(os.path.join(os.getcwd(), "experimental_set.json"))
